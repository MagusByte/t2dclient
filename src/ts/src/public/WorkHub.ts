...
import { ChecklistAddItemRequest, ChecklistAddItemResponse } from "./checklist/ChecklistAddItemRequest";
import { ChecklistChangeOrderRequest, ChecklistChangeOrderResponse } from "./checklist/ChecklistChangeOrderRequest";
import { ChecklistCreateRequest, ChecklistCreateResponse } from "./checklist/ChecklistCreateRequest";
import { ChecklistDeleteRequest, ChecklistDeleteResponse } from "./checklist/ChecklistDeleteRequest";
import { ChecklistRemoveItemRequest, ChecklistRemoveItemResponse } from "./checklist/ChecklistRemoveItemRequest";
...
export class WorkHub<HubClient extends IHubClient> implements IWorkHub {
  ...
  constructor(private hubClient: HubClient) {
    ...
    this.hubClient.on('OnMapSet', (item) => this.invokeHandler("OnMapSet", item));
    this.hubClient.on('OnPlacementDeleted', (item) => this.invokeHandler("OnPlacementDeleted", item));
    this.hubClient.on('OnPlacementSet', (item) => this.invokeHandler("OnPlacementSet", item));
    this.hubClient.on('OnTaskDeleted', (item) => this.invokeHandler("OnTaskDeleted", item));
  ...
  async subscribeToWorkspace(workspaceId: string): Promise<SubscribeToWorkspaceResponse> {
    return await this.hubClient.invoke<SubscribeToWorkspaceResponse>('subscribeToWorkspace', workspaceId);
  }
  ...
  async createTask(request: TaskCreateRequest): Promise<TaskCreateResponse> {
    return await this.hubClient.invoke<TaskCreateResponse>('createTask', request);
  }

  async updateTask(request: TaskUpdateRequest): Promise<TaskUpdateResponse> {
    return await this.hubClient.invoke<TaskUpdateResponse>('updateTask', request);
  }

  async deleteTask(request: TaskDeleteRequest): Promise<TaskDeleteResponse> {
    return await this.hubClient.invoke<TaskDeleteResponse>('deleteTask', request);
  }
  ...
  async createPlacement(request: PlacementCreateRequest): Promise<PlacementCreateResponse> {
    return await this.hubClient.invoke<PlacementCreateResponse>('createPlacement', request);
  }

  async updatePlacement(request: PlacementUpdateRequest): Promise<PlacementUpdateResponse> {
    return await this.hubClient.invoke<PlacementUpdateResponse>('updatePlacement', request);
  }

  async deletePlacement(request: PlacementDeleteRequest): Promise<PlacementDeleteResponse> {
    return await this.hubClient.invoke<PlacementDeleteResponse>('deletePlacement', request);
  }

  async createLink(request: LinkCreateRequest): Promise<LinkCreateResponse> {
    return await this.hubClient.invoke<LinkCreateResponse>('createLink', request);
  }

  async previewLinkCreate(request: LinkCreatePreviewRequest): Promise<LinkCreatePreviewResponse> {
    return await this.hubClient.invoke<LinkCreatePreviewResponse>('previewLinkCreate', request);
  }

  async deleteLink(request: LinkDeleteRequest): Promise<LinkDeleteResponse> {
    return await this.hubClient.invoke<LinkDeleteResponse>('deleteLink', request);
  }

  async createWorkspace(request: WorkspaceCreateRequest): Promise<WorkspaceCreateResponse> {
    return await this.hubClient.invoke<WorkspaceCreateResponse>('createWorkspace', request);
  }

  async updateWorkspace(request: WorkspaceUpdateRequest): Promise<WorkspaceUpdateResponse> {
    return await this.hubClient.invoke<WorkspaceUpdateResponse>('updateWorkspace', request);
  }

  async getWorkspaceSubscription(request: WorkspaceSubscriptionRequest): Promise<WorkspaceSubscriptionResponse> {
    return await this.hubClient.invoke<WorkspaceSubscriptionResponse>('getWorkspaceSubscription', request);
  }

  async deleteWorkspace(request: WorkspaceDeleteRequest): Promise<WorkspaceDeleteResponse> {
    return await this.hubClient.invoke<WorkspaceDeleteRequest>('deleteWorkspace', request);
  }

  async removeWorkspaceMember(request: WorkspaceRemoveMemberRequest): Promise<WorkspaceRemoveMemberResponse> {
    return await this.hubClient.invoke<WorkspaceRemoveMemberResponse>('removeWorkspaceMember', request);
  }

  async createTutorial(request: WorkspaceCreateTutorialRequest): Promise<WorkspaceCreateTutorialResponse> {
    return await this.hubClient.invoke<WorkspaceCreateTutorialResponse>('createTutorial', request);
  }

  async markAsTutorial(request: WorkspaceMarkAsTutorialTemplateRequest): Promise<WorkspaceMarkAsTutorialTemplateResponse> {
    return await this.hubClient.invoke<WorkspaceMarkAsTutorialTemplateResponse>('markAsTutorial', request);
  }
  ...
  async createTaskPropertyDefinition(request: TaskPropertyDefinitionCreateRequest): Promise<TaskPropertyDefinitionCreateResponse> {
    return await this.hubClient.invoke<TaskPropertyDefinitionCreateResponse>('createTaskPropertyDefinition', request);
  }
  ...
  async deleteTaskPropertyDefinition(request: TaskPropertyDefinitionDeleteRequest): Promise<TaskPropertyDefinitionDeleteResponse> {
    return await this.hubClient.invoke<TaskPropertyDefinitionDeleteResponse>('deleteTaskPropertyDefinition', request);
  }

  async createInvite(request: InviteCreateRequest): Promise<InviteCreateResponse> {
    return await this.hubClient.invoke<InviteCreateResponse>('createInvite', request);
  }
  async listInvites(request: InviteListRequest): Promise<InviteListResponse> {
    return await this.hubClient.invoke<InviteListResponse>('listInvites', request);
  }
  async revokeInvite(request: InviteRevokeRequest): Promise<InviteRevokeResponse> {
    return await this.hubClient.invoke<InviteRevokeResponse>('revokeInvite', request);
  }
  async previewInvite(request: InvitePreviewRequest): Promise<InvitePreviewResponse> {
    return await this.hubClient.invoke<InvitePreviewResponse>('previewInvite', request);
  }
  async acceptInvite(request: InviteAcceptRequest): Promise<InviteAcceptResponse> {
    return await this.hubClient.invoke<InviteAcceptResponse>('acceptInvite', request);
  }

  async createWorkspaceToken(request: WorkspaceTokenCreateRequest): Promise<WorkspaceTokenCreateResponse> {
    return await this.hubClient.invoke<WorkspaceTokenCreateResponse>('createWorkspaceToken', request);
  }
  async listWorkspaceTokens(request: WorkspaceTokenListRequest): Promise<WorkspaceTokenListResponse> {
    return await this.hubClient.invoke<WorkspaceTokenListResponse>('listWorkspaceTokens', request);
  }
  async revokeWorkspaceToken(request: WorkspaceTokenRevokeRequest): Promise<WorkspaceTokenRevokeResponse> {
    return await this.hubClient.invoke<WorkspaceTokenRevokeResponse>('revokeWorkspaceToken', request);
  }
